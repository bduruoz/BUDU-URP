...
Shader "Raymarch"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 Raymarch210( float3 rayOrigin, float3 rayDirection, int numSteps, float stepSize, float densityScale, sampler3D Volume, float3 offset, int numLightSteps, float lightStepSize, float3 lightDir, float lightAbsorb, float darknessThreshold, float transmittance )
			{
				float density = 0;
				 ...
				 ) : SV_Target
			{
				...
				float3 localRaymarch210 = Raymarch210( rayOrigin10 , rayDirection10 , numSteps10 , stepSize10 , densityScale10 , Volume10 , offset10 , numLightSteps10 , lightStepSize10 , lightDir10 , lightAbsorb10 , darknessThreshold10 , transmittance10 );
				float3 break32 = localRaymarch210;
...
Node;AmplifyShaderEditor.TransformPositionNode;43;-806.709,-395.9742;Inherit;False;World;Object;False;Fast;True;1;0;FLOAT3;0,0,0;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ScaleAndOffsetNode;44;144,-160;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;46;368,-240;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;45;528,-192;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;47;704,-240;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;39;912,-384;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;41;-80,-464;Inherit;False;Property;_Color1;Color 1;10;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;40;-80,-656;Inherit;False;Property;_Color0;Color 0;11;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=1B2F60E09EE58BA87792DFED94DA26349BE025B1