...
public class EBWaterSurfaceEditor_Eski : ShaderGUI
{
    bool checkSurface, checkAlpha, checkMiddle, checkDeform, checkNormal, checkShore, checkReflect, checkRefract, checkFog, checkNormTxt, checkSSBlur, checkFlowMap, checkDisp, checkDef;
