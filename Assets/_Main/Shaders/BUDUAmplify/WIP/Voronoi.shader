...
Shader "BUDU Shaders/WIP/BVoronoi"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		_vorScale("vorScale", Float) = 1
		_VorAngle("VorAngle", Float) = 0
		_VorTilex("VorTilex", Float) = 1
		_VorTileY("VorTileY", Float) = 1
		_VorOffsetX("VorOffsetX", Float) = 1
		_VorOffsetY("VorOffsetY", Float) = 1
		_VorAnchorX("VorAnchorX", Float) = 1
		_VorAnchorY("VorAnchorY", Float) = 1
		_VorRotate("VorRotate", Float) = 0
		_VorOctave("VorOctave", Int) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float time14 = radians( _VorAngle );
				float2 voronoiSmoothId14 = 0;
				float voronoiSmooth14 = 0.0;
				float2 appendResult19 = (float2(_VorTilex , _VorTileY));
				float2 appendResult23 = (float2(_VorOffsetX , _VorOffsetY));
				float2 texCoord20 = IN.ase_texcoord8.xy * appendResult19 + appendResult23;
				float2 appendResult26 = (float2(_VorAnchorX , _VorAnchorY));
				float cos15 = cos( _VorRotate );
				float sin15 = sin( _VorRotate );
				float2 rotator15 = mul( texCoord20 - appendResult26 , float2x2( cos15 , -sin15 , sin15 , cos15 )) + appendResult26;
				float2 coords14 = rotator15 * _vorScale;
				float2 id14 = 0;
				float2 uv14 = 0;
				float voroi14 = voronoi14( coords14, time14, id14, uv14, voronoiSmooth14, voronoiSmoothId14 );
				float3 temp_cast_0 = (voroi14).xxx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult19 = (float2(_VorTilex , _VorTileY));
				float2 appendResult23 = (float2(_VorOffsetX , _VorOffsetY));
				float2 texCoord20 = IN.ase_texcoord4.xy * appendResult19 + appendResult23;
				float2 appendResult26 = (float2(_VorAnchorX , _VorAnchorY));
				float cos15 = cos( _VorRotate );
				float sin15 = sin( _VorRotate );
				float2 rotator15 = mul( texCoord20 - appendResult26 , float2x2( cos15 , -sin15 , sin15 , cos15 )) + appendResult26;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult19 = (float2(_VorTilex , _VorTileY));
				float2 appendResult23 = (float2(_VorOffsetX , _VorOffsetY));
				float2 texCoord20 = IN.ase_texcoord2.xy * appendResult19 + appendResult23;
				float2 appendResult26 = (float2(_VorAnchorX , _VorAnchorY));
				float cos15 = cos( _VorRotate );
				float sin15 = sin( _VorRotate );
				float2 rotator15 = mul( texCoord20 - appendResult26 , float2x2( cos15 , -sin15 , sin15 , cos15 )) + appendResult26;
...
/*ASEBEGIN
Version=19404
Node;AmplifyShaderEditor.RangedFloatNode;12;-368,112;Inherit;False;Property;_vorScale;vorScale;0;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-368,240;Inherit;False;Property;_VorSmootness;VorSmootness;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-880,-544;Inherit;False;Property;_VorTilex;VorTilex;3;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-880,-464;Inherit;False;Property;_VorTileY;VorTileY;4;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;19;-720,-496;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;20;-480,-416;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;4,4;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;-928,-336;Inherit;False;Property;_VorOffsetX;VorOffsetX;5;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-928,-256;Inherit;False;Property;_VorOffsetY;VorOffsetY;6;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;23;-736,-304;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-544,-208;Inherit;False;Property;_VorAnchorX;VorAnchorX;7;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-544,-128;Inherit;False;Property;_VorAnchorY;VorAnchorY;8;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;26;-352,-176;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RadiansOpNode;28;-272,0;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-448,16;Inherit;False;Property;_VorAngle;VorAngle;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-192,-96;Inherit;False;Property;_VorRotate;VorRotate;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RotatorNode;15;48,-224;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.IntNode;29;219.7771,264.1831;Inherit;False;Property;_VorOctave;VorOctave;10;0;Create;True;0;0;0;True;0;False;1;0;False;0;1;INT;0
Node;AmplifyShaderEditor.VoronoiNode;14;304,-176;Inherit;False;0;0;1;0;1;False;63;False;True;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
ASEEND*/
//CHKSM=C6AA49114F0E5FE2DC938AC872F749B7545D5B10