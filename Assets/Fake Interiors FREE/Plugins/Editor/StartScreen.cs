...
namespace AseFakeInterior
{
	...
	{
		public static readonly string PrefStartUp = "FILastSession" + Application.productName;
		public static readonly string PrefForceUpdate = "FIForceUpdate" + Application.productName;
	}

	public class StartScreen : EditorWindow
	{
		[MenuItem( "Window/Fake Interiors/Start Screen", false, 19 )]
		public static void Init()
		{
			StartScreen window = (StartScreen)GetWindow( typeof( StartScreen ), true, "Fake Interiors Start Screen" );
			window.minSize = new Vector2( 650, 500 );
			window.maxSize = new Vector2( 650, 500 );
			window.Show();
		}

		public static readonly string RefID = "Ref_Fake";
		...
		private static readonly string IconGUID = "1bebea1ffcd49b04ebdf740a4a576413";
		private static readonly string BannerGUID = "c22fa2c9354f8ae4c936cfce17e7e1a5";

		public static readonly string BannerInfoURL = "http://amplify.pt/Banner/FIInfo.json";
		public static readonly string PackageRefURL = "http://amplify.pt/Banner/PackageRef.json";

		private static readonly string WikiURL = "http://wiki.amplify.pt/index.php?title=Unity_Products:Fake_Interiors";

		private static readonly string DiscordURL = "https://discordapp.com/invite/EdrVAP5";
		private static readonly string ForumURL = "https://forum.unity.com/threads/free-fake-interiors-package-fully-editable-w-amplify-shader-editor.505450/";

		private static readonly string SiteURL = "http://amplify.pt/download/";
		private static readonly string StoreURL = "https://assetstore.unity.com/packages/vfx/shaders/fake-interiors-free-104029?aid=1011lPwI&pubref=" + RefID;
		...
		private static readonly GUIContent TitleSTR = new GUIContent( "Fake Interiors" );
