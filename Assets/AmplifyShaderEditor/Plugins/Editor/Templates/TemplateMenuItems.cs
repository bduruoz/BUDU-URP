...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[MenuItem( "Assets/Create/Amplify Shader/Universal/BUDULit", false, 85 )]
		public static void ApplyTemplateUniversalBUDULit()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "dcf3e680117c48a4cb69c2c58c49ec28" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/Universal/BUDUUnlit", false, 85 )]
		public static void ApplyTemplateUniversalBUDUUnlit()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "7489fd76ebdb00b448e337e26be4b0c3" );
		}
