...
{	
	Properties
    {        
		_WireframeShader_Thickness("", Range(0, 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
            ...
            {
                return saturate(WireframeShaderReadTriangleMassFromUV(i.triangleMass, _WireframeShader_Thickness, _WireframeShader_Smoothness) * 2);
            }
